...
class ContainerFactory
{
    ...
    public static function create(string $rootPath): ContainerInterface
    {
        ...
        $containerBuilder->addDefinitions($rootPath . '/app/Config/container-definitions.php');
        $containerBuilder->addDefinitions($rootPath . '/app/Config/container-controllers.php');
